...
## USB-UART
#set_property -dict { PACKAGE_PIN U1 IOSTANDARD LVCMOS33 } [get_ports UART_Rx];
#set_property -dict { PACKAGE_PIN V1 IOSTANDARD LVCMOS33 } [get_ports UART_Tx];


## 4-bits 7-segment Display
#set_property -dict { PACKAGE_PIN A9  IOSTANDARD LVCMOS33 } [get_ports {sel[3]}];	#AN4
#set_property -dict { PACKAGE_PIN A10 IOSTANDARD LVCMOS33 } [get_ports {sel[2]}];	#AN3
#set_property -dict { PACKAGE_PIN C14 IOSTANDARD LVCMOS33 } [get_ports {sel[1]}];	#AN2
#set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS33 } [get_ports {sel[0]}];	#AN1
#set_property -dict { PACKAGE_PIN C15 IOSTANDARD LVCMOS33 } [get_ports {data[7]}];	#DP
#set_property -dict { PACKAGE_PIN D15 IOSTANDARD LVCMOS33 } [get_ports {data[6]}];	#CG
#set_property -dict { PACKAGE_PIN D13 IOSTANDARD LVCMOS33 } [get_ports {data[5]}];	#CF
#set_property -dict { PACKAGE_PIN D12 IOSTANDARD LVCMOS33 } [get_ports {data[4]}];	#CE
#set_property -dict { PACKAGE_PIN F14 IOSTANDARD LVCMOS33 } [get_ports {data[3]}];	#CD
#set_property -dict { PACKAGE_PIN F13 IOSTANDARD LVCMOS33 } [get_ports {data[2]}];	#CC
#set_property -dict { PACKAGE_PIN A11 IOSTANDARD LVCMOS33 } [get_ports {data[1]}];	#CB
#set_property -dict { PACKAGE_PIN B11 IOSTANDARD LVCMOS33 } [get_ports {data[0]}];	#CA
...
#set_property -dict { PACKAGE_PIN V11 IOSTANDARD LVCMOS33 } [get_ports JPA3];	#JPA3
#set_property -dict { PACKAGE_PIN V10 IOSTANDARD LVCMOS33 } [get_ports JPA4];	#JPA4
#set_property -dict { PACKAGE_PIN U13 IOSTANDARD LVCMOS33 } [get_ports JPA7];	#JPA7
#set_property -dict { PACKAGE_PIN T13 IOSTANDARD LVCMOS33 } [get_ports JPA8];	#JPA8
#set_property -dict { PACKAGE_PIN U11 IOSTANDARD LVCMOS33 } [get_ports JPA9];	#JPA9
#set_property -dict { PACKAGE_PIN T11 IOSTANDARD LVCMOS33 } [get_ports JPA10];	#JPA10
## Pmod B
...
#set_property -dict { PACKAGE_PIN A13 IOSTANDARD LVCMOS33 } [get_ports JPD7];	#JPD7
#set_property -dict { PACKAGE_PIN A14 IOSTANDARD LVCMOS33 } [get_ports JPD8];	#JPD8
#set_property -dict { PACKAGE_PIN A15 IOSTANDARD LVCMOS33 } [get_ports JPD9];	#JPD9
#set_property -dict { PACKAGE_PIN A16 IOSTANDARD LVCMOS33 } [get_ports JPD10];	#JPD10
